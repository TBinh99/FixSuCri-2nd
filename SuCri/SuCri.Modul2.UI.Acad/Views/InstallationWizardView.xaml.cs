...
namespace SuCri.Modul2.UI.Acad
{
    ...
    /// </summary>
    public partial class InstallationWizardView : Window
    {
        ...
        private void MailButton_Click(object sender, RoutedEventArgs e)
        {
            if (Theme == "Sikla")
            {
                ...
                var betreff = "Problem with Installation - Sikla Extension";
            ...
            else if (Theme == "MPSS")
            {
                ...
                var betreff = "Problem with Installation - MPSS Extension";
        ...
        {
            MessageBox.Show(Properties.Settings.Default.IsRegisterCmdDone.ToString());
        }
    }
